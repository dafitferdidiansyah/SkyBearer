...
const FAQItem = (props: { question: string; answer: string }) => (
  <div className="mb-6 border-b border-gray-200 pb-4">
    <h3 className="text-lg font-bold text-gray-900 mb-2">Q: {props.question}</h3>
...
const FAQ = () => (
  ...
  >
    <div className="mt-8 max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
      <FAQItem 
